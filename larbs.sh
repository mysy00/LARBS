...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/mysy00/dotfiles.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/mysy00/LARBS/master/progs.csv"
...
for x in curl base-devel git ntp zsh yadm; do
...
sudo -u "$name" mkdir -p "/home/$name/Pictures"
